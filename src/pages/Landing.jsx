    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#051040] text-white pb-24 font-sans overflow-x-hidden relative">
            ...
            <div className="flex items-center justify-between p-6 pt-8 z-50 relative max-w-7xl mx-auto w-full">
                ...
                <Link to="/results" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors relative border border-white/10 group">
                    <Trophy size={20} className="text-[#FDB931] group-hover:text-white transition-colors" />
